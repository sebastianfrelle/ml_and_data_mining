...
mat_data = loadmat('toolbox/Data/wine2.mat')
X = mat_data['X']
...
t = Error_test[0]
j = 0
for i, v in enumerate(Error_test):
    if v < t:
        t = v
        j = i
...
out = tree.export_graphviz(
    dtc, out_file='tree_611.gvz', feature_names=attributeNames)
# graphviz.render('dot','png','tree_gini',quiet=False)
src = graphviz.Source.from_file('tree_611.gvz')
